    ...
    <main className="main-content">
      ...
      <section className="cards-section">
        ...
        <div className="cards-container">
          <div className="card">
            <img src="/images/hospital.jpg" className="card-image" alt="Services de qualité" />
          ...
          <div className="card">
            <img src="/images/doctors.jpg" className="card-image" alt="Équipe expérimentée" />
          ...
          <div className="card">
            <img src="/images/emergency.jpg" className="card-image" alt="Disponibilité 24/7" />
        ...
        <div className="cards-container">
          <div className="card">
            <img src="/images/treatment.jpg" className="card-image" alt="Traitements innovants" />
          ...
          <div className="card">
            <img src="/images/care.jpg" className="card-image" alt="Approche humaine" />
          ...
          <div className="card">
            <img src="/images/access.jpg" className="card-image" alt="Accessibilité" />
            <h3>Accessibilité</h3>
